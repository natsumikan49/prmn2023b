...
public class PreExamDAO {
    ...
    private static final String USER_NAME = "b2221620";
    private static final String USER_PASS = "b2221620";

    public List<PreExam> selectPreExams(int lessThan) throws SQLException {
        List<PreExam> returning = new ArrayList<>();
        String SQL = "SELECT 学生コード FROM 学生情報 WHERE 得点 < ?";
        ...
        try (Connection conn = DriverManager.getConnection(URL, USER_NAME, USER_PASS);
            ...
            while (result.next()) {
                ...
                String col2 = result.getString("氏");
                String col3 = result.getString("名");
